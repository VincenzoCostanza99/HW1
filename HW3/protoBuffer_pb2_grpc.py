...
class UserServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Registrazione_utente = channel.unary_unary(
                '/HW2.UserService/Registrazione_utente',
        ...
        self.Aggiornamento_utente = channel.unary_unary(
                '/HW2.UserService/Aggiornamento_utente',
        ...
        self.Get_Last_Value = channel.unary_unary(
                '/HW2.UserService/Get_Last_Value',
                ...
                _registered_method=True)
        self.Aggiornamento_Soglia = channel.unary_unary(
                '/HW2.UserService/Aggiornamento_Soglia',
                request_serializer=protoBuffer__pb2.Aggiornamento_Soglia_Request.SerializeToString,
                response_deserializer=protoBuffer__pb2.Aggiornamento_Soglia_Reply.FromString,
                _registered_method=True)
        self.Get_Media = channel.unary_unary(
                '/HW2.UserService/Get_Media',
...
def add_UserServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Aggiornamento_Soglia': grpc.unary_unary_rpc_method_handler(
                    servicer.Aggiornamento_Soglia,
                    request_deserializer=protoBuffer__pb2.Aggiornamento_Soglia_Request.FromString,
                    response_serializer=protoBuffer__pb2.Aggiornamento_Soglia_Reply.SerializeToString,
            ),
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'HW2.UserService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('HW2.UserService', rpc_method_handlers)
...
class UserService(object):
    ...
    @staticmethod
    def Aggiornamento_Soglia(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/HW2.UserService/Aggiornamento_Soglia',
            protoBuffer__pb2.Aggiornamento_Soglia_Request.SerializeToString,
            protoBuffer__pb2.Aggiornamento_Soglia_Reply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
